    ...
    >
      <View className="flex-1 items-center">
        ...
        >
          ...
          />
          <View style={{ gap: wp("1%") }}>
            <Text className="font-bold text-xl capitalize text-center">
              {user.fullName}
            </Text>
          ...
          buttons={[
            {
              ...
              label: "Hedefler",
              style: {
                backgroundColor: value === "goals" ? "#3f6942" : "white",
                borderWidth: value === "goals" ? 0 : 1,
                borderColor: "black",
              },
              labelStyle: {
                color: value === "goals" ? "white" : "black",
              },
            },
            {
              value: "chart",
              label: "Tüketilenler",
              style: {
                backgroundColor: value === "chart" ? "#3f6942" : "white",
                borderWidth: value === "chart" ? 0 : 1,
                borderColor: "black",
              },
              labelStyle: {
                color: value === "chart" ? "white" : "black",
              },
            },
          ]}
        />
        ...
        <Text style={{ marginVertical: wp("3%") }} className="text-lg italic">
          Kişisel Bilgiler
        </Text>
        <View style={{ gap: wp("4%"), padding: wp("2%"), width: wp("85%") }}>
          <Pressable
